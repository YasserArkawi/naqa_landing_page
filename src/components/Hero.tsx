        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-7xl font-extrabold text-gray-900 leading-tight">
              نقاء، <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-600 to-cyan-500">لسلسلة توريد ذكية في سوريا</span>
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-4 mt-4">
              <a href="#individuals" className="group flex items-center gap-2 bg-brand-600 hover:bg-brand-700 text-white px-8 py-3.5 rounded-full font-bold transition-all shadow-lg shadow-brand-600/30 hover:shadow-xl hover:shadow-brand-600/40">
                <span>ابدأ رحلتك مع نقاء</span>
                <ArrowLeft size={20} className="group-hover:-translate-x-1 transition-transform" />
              </a>
              <a href="#factories" className="px-8 py-3.5 rounded-full font-bold text-brand-700 bg-white hover:bg-brand-50 border border-brand-100 transition-all shadow-sm flex items-center gap-2">
                <Box size={20} />
                احجز شحنتك النقية
              </a>
            </div>
          ...
          >
            <div className="relative rounded-3xl overflow-hidden shadow-2xl aspect-[4/3]">
              <img 
                ...
                alt="فرز البلاستيك وإعادة التدوير" 
            ...
            <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-2xl shadow-xl flex items-center gap-4">
              ...
              <div>
                <p className="text-xl font-bold text-gray-900">نظام نقاط</p>
                <p className="text-sm font-medium text-gray-500">نقاط مقابل كل قطعة بلاستيك</p>
              </div>
            </div>
          </motion.div>
        </div>
